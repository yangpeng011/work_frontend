  ...
  <div class="app-container">
    ...
    <el-dialog :title="title" :visible.sync="open" width="700px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="100px">
        <el-row :gutter="20">
          ...
          <el-col :span="12">
            <el-form-item label="接收人" prop="orderReceiverId">
              <el-select v-model="form.orderReceiverId" placeholder="请选择接收人" disabled filterable>
                <el-option
        ...
        <el-row :gutter="20">
          ...
          <el-col :span="12">
            <el-form-item label="积分数量" prop="integralNum">
              <el-input-number v-model="form.integralNum" placeholder="请输入积分数量" :min="0" :step="0.1"
        ...
        <el-row :gutter="20" v-if="form.status ==4">
          <el-col :span="24">
            <el-form-item label="审核意见" prop="auditOpinion">
              <el-input v-model="form.auditOpinion" type="textarea" placeholder="请输入审核意见" :rows="4" disabled/>
            </el-form-item>
          </el-col>
        </el-row>
        ...
        <el-row :gutter="20">
          <el-col :span="24">
            <el-form-item label="佐证文件" prop="evidence">
              <file-upload v-model="form.evidence" :disabled="operateType === 2"/>
            </el-form-item>
          </el-col>
        </el-row>
        <el-row :gutter="20">
          <el-col :span="24">
            <el-form-item label="佐证说明" prop="evidenceDesc">
              <el-input v-model="form.evidenceDesc" type="textarea" placeholder="请输入内容" :rows="4"
      ...
      <div slot="footer" class="dialog-footer">
        <el-button type="primary" @click="submitForm" v-if="operateType === 1" :loading="submitLoading">确 定
        </el-button>
...
<script>
import {myListWorkOrder, getWorkOrder, delWorkOrder, updateWorkOrder, generateFixedOrders} from "@/api/workOrder/order";
...
export default {
  ...
  methods: {
    ...
    getList() {
      this.loading = true;
      myListWorkOrder(this.queryParams).then(response => {
    ...
    /** 生成固定单*/
    generateFixedOrders() {
      this.$modal.confirm('是否确认生成固定单？').then(function () {
        return generateFixedOrders();
      }).then((
        () => {
    ...
    getUserList() {
      selectList().then(response => {
          ...
          console.log("receiverOptions:", this.receiverOptions)
        }
      );
    },
    /** 查询任务列表 */
