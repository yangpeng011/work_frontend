...
<!--          :disabled="single"-->
<!--          @click="handleUpdate"-->
<!--          v-hasPermi="['basic:taskConfig:edit']"-->
<!--        >修改</el-button>-->
<!--      </el-col>-->
<!--      <el-col :span="1.5">-->
<!--        <el-button-->
...
<!--          :disabled="multiple"-->
<!--          @click="handleDelete"-->
<!--          v-hasPermi="['basic:taskConfig:remove']"-->
<!--        >删除</el-button>-->
<!--      </el-col>-->
<!--      <el-col :span="1.5">-->
<!--        <el-button-->
...
<!--          size="mini"-->
<!--          @click="handleExport"-->
<!--          v-hasPermi="['basic:taskConfig:export']"-->
<!--        >导出</el-button>-->
<!--      </el-col>-->
...
<script>
import { listTaskConfig, getTaskConfig, delTaskConfig, addTaskConfig, updateTaskConfig } from "@/api/basic/taskConfig";
...
export default {
  ...
  methods: {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('basic/taskConfig/export', {
        ...this.queryParams
      }, `taskConfig_${new Date().getTime()}.xlsx`)
    }
  }
};
</script>
